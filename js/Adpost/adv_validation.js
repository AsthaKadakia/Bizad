$(document).ready(function(){
...

	{
...

		{
			...
			termidInfo.text("Please Select Category");
...

	{
...

		{
			...
			post_titleInfo.text("Please Enter Ads Title");
...

	{
...

		{
			...
			post_locationInfo.text("Please Enter Location");
...

	{
		...
		}else*/
		{
			...
			var description_str = $("#description").val();
